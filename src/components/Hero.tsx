...
export default function Hero() {
  ...
  const itemVariants = {
    ...
    visible: { 
      ...
      transition: { 
        duration: 0.8, 
        ease: "easeOut" as const /* <--- 'as const' FIXES THE TYPESCRIPT ERROR */
      } 
    }
  };
  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center border-b border-white/10">
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 text-center relative z-10 pt-10">
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="flex flex-col items-center justify-center space-y-8">
          ...
          <motion.p variants={itemVariants} className="max-w-2xl text-lg md:text-xl text-gray-200 font-sans drop-shadow-lg">
